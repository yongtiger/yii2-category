        ...
        'nodeActions' => [          ///optional
            ...
            'delete' => [
                ...
                'actionOptions' => [
                    ...
                    'data-confirm' => Module::t('message', 'Are you sure you want to delete this item?'),   ///you'd better to use `i18n` in TreeView config
                    'data-method' => 'post',
                    ///for ajax
            ...
            'delete-all' => [
                ...
                'actionOptions' => [
                    ...
                    'data-confirm' => Module::t('message', 'Are you sure you want to delete this item and its children?'), ///you'd better to use `i18n` in TreeView config
                    'data-method' => 'post',
                    ///for ajax
                    // 'href' => 'javascript:void(0)', ///Note: It will override the 'href' of `nodeActionOptions`
